...
ExamSubmitModel examSubmitModelFromJson(String str) => ExamSubmitModel.fromJson(json.decode(str));

String examSubmitModelToJson(ExamSubmitModel data) => json.encode(data.toJson());
...
class ExamSubmitModel {
  ...
  factory ExamSubmitModel.fromJson(Map<String, dynamic> json) => ExamSubmitModel(
    status: json["status"],
