...
class RunExamView extends StatefulWidget {
  ...
  const RunExamView({super.key, required this.examStartModel});

  @override
  State<RunExamView> createState() => _RunExamViewState();
}

class _RunExamViewState extends State<RunExamView> {
  @override
  Widget build(BuildContext context) {
    final controller = Get.put(ExamStartController(widget.examStartModel));
  ...
  Widget customQuestionWidget(
      ExamStartController controller, Question question) {
  ...
  Widget _buildSingleChoice(ExamStartController controller, Question question) {
    return Column(
