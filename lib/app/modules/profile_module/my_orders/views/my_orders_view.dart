    ...
    return Scaffold(
      ...
      body: Obx(
          ...
          child: switch (controller.apiCallStatus.value) {
            ApiCallStatus.loading => const Center(child: CircularProgressIndicator()),
            ApiCallStatus.error => const Center(child: Text("অর্ডার লোড করতে সমস্যা হয়েছে")),
            ApiCallStatus.success => ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return InkWell(
                  //onTap: () => Get.to(() => OrderDetailsScreen(orderId: data.id!.toInt())),
                  child: OrderCard(
