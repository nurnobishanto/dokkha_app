...
import '../controllers/mock_exam_result_controller.dart';
import '../models/exam_result_model.dart';

class MockExamResultScreen extends StatelessWidget {
  final MockExamResultModel model;
  const MockExamResultScreen({super.key, required this.model});

  @override
  Widget build(BuildContext context) {
    final questionList = model.results;
    final MockExamResultController controller =
        Get.put(MockExamResultController());
    return Scaffold(
      appBar: AppBar(
