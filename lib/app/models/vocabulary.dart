...
class Vocabulary {
  ...
  Map<String, dynamic> toJson() => {
    ...
    "word": word,
    "details": details,
    "synonym": synonym == null ? [] : List<dynamic>.from(synonym!.map((x) => x)),
    "antonym": antonym == null ? [] : List<dynamic>.from(antonym!.map((x) => x)),
    "wrong_synonym": wrongSynonym == null ? [] : List<dynamic>.from(wrongSynonym!.map((x) => x)),
    "wrong_antonym": wrongAntonym == null ? [] : List<dynamic>.from(wrongAntonym!.map((x) => x)),
    "status": status,
